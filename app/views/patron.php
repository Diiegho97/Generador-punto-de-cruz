    ...
    <div class="card shadow rounded-3" style="background: rgba(255,255,255,0.92);">
        <div class="card-body p-3 p-md-4">
            ...
            <div class="text-center mb-4">
                <img src="uploads/<?= htmlspecialchars(basename($nombreOriginal)) ?>" class="img-fluid border rounded" style="max-width:100%;height:auto;max-height:350px;" alt="Patrón de punto de cruz">
            </div>
            <div class="text-center mb-4">
